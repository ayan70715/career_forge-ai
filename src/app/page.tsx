...
export default function HomePage() {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      ...
      {/* ── Bento Grid ──
        New layout (3-col on lg):
        ┌─────────────────────┬───────────────────┐
        │  Resume Builder     │  AI Enhancer      │  row 1  (2 + 1 col)
        │  (col-span-2, tall) │  (col-span-1)     │
        ├──────────┬──────────┼───────────────────┤
        │ ATS      │ CV/Cover │  Resume Verifier  │  row 2  (1+1+1)
        │ Checker  │ Letter   │                   │
        ├──────────┴──────────┼───────────────────┤
        │  Job Analyse        │  Interview Prep   │  row 3  (2+1)
        │  (col-span-2, tall) │  (col-span-1)     │
        ├─────────────────────┴───────────────────┤
        │  Project Analyse   │  Stat Card         │  row 4  (2+1)
        └────────────────────┴────────────────────┘
      -->
      */}
      <motion.section
      ...
      >
        <BentoGrid className="lg:grid-cols-3 auto-rows-auto">
          ...
          {/* ── Row 1: Resume Builder — col-span-2, taller ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="sm:col-span-2 lg:col-span-2 lg:col-start-1 lg:row-start-1"
          >
            <BentoCard href="/resume-builder" className="h-full min-h-[280px]">
          ...
          {/* ── Row 1: AI Enhancer — col 3, row-span-2 (taller) ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-3 lg:row-start-1 lg:row-span-2"
          >
            <BentoCard href="/ai-enhance" className="h-full min-h-[300px]">
          ...
          {/* ── Row 2: ATS Checker — col 1 ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-1 lg:row-start-2"
          >
            <BentoCard href="/ats-checker" className="h-full min-h-[200px]">
              <div className="p-5 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-3">
          ...
          {/* ── Row 2: CV / Cover Letter — col 2 ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-2 lg:row-start-2"
          >
            <BentoCard href="/cv-generator" className="h-full min-h-[200px]">
              <div className="p-5 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-3">
          ...
          {/* ── Row 3: Job Analyse — col-span-2, taller ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="sm:col-span-2 lg:col-span-2 lg:col-start-1 lg:row-start-3"
          >
            <BentoCard href="/job-analyse" className="h-full min-h-[320px]">
              <div className="p-6 h-full flex flex-col">
                {/* Header */}
                ...
                <p className="text-xs text-muted-foreground mb-4 leading-relaxed max-w-md">
                  Real-time salary benchmarking and skill-gap analysis for the Indian tech ecosystem.
                </p>

                {/* Animation container */}
                <div className="flex-1 bg-black/40 rounded-xl p-4 border border-white/5 relative overflow-hidden group-hover:border-blue-500/20 transition-colors">
                  <JobAnalysePreview />
                </div>
              </div>
            </BentoCard>
          ...
          {/* ── Row 3: Interview Prep — col 3 ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-3 lg:row-start-3"
          >
            <BentoCard href="/interview-prep" className="h-full min-h-[200px]">
              <div className="p-5 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-3">
          ...
          {/* ── Row 4: Resume Verifier — col 1 ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-1 lg:row-start-4"
          >
            <BentoCard href="/resume-verifier" className="h-full min-h-[200px]">
              <div className="p-5 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-3">
          ...
          {/* ── Row 4: Project Analyse — col 2 ── */}
          <motion.div
            variants={fadeUp}
            transition={{ duration: 0.5 }}
            className="lg:col-start-2 lg:row-start-4"
          >
            <BentoCard href="/project-analyse" className="h-full min-h-[200px]">
              <div className="p-5 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-3">
          ...
          >
            <div className="h-full min-h-[200px] rounded-2xl border border-glass-border bg-glass-bg backdrop-blur-md p-5 flex flex-col items-center justify-center text-center gap-3">
