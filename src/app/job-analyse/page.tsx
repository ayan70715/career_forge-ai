...
interface AnalysisResult {
  ...
  userSalaryEstimate: number;          // ₹ LPA where user lands
  ...
  return (
    <div style={{ position: "relative", width: "180px", height: "180px" }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: "36px", fontWeight: 700, color, fontFamily: "'Syne', sans-serif", lineHeight: 1 }}>
          {displayed}
        </span>
        <span style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", marginTop: "2px", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.08em" }}>
          MATCH
        </span>
      </div>
    </div>
  ...
  return (
    <div style={{ width: "100%" }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
        ...
        <span style={{ fontSize: "13px", fontWeight: 700, color, fontFamily: "'Syne', sans-serif" }}>
          ₹{userVal}L estimated
        </span>
      ...
      <div style={{
        ...
        <div style={{
          ...
          transition: "left 0.02s linear, background 0.5s ease",
        }} />
      </div>
...
export default function JobAnalyserPage() {
  ...
  const LOADING_MSGS = [
    ...
    "Scanning 10,000+ active job listings...",
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes glow {
          0%,100% { box-shadow: 0 0 20px rgba(99,210,255,0.2); }
          50% { box-shadow: 0 0 40px rgba(99,210,255,0.5); }
        }
      ...
      <div style={{
        minHeight: "100vh",
        background: "radial-gradient(ellipse at 10% 0%, #0d1f35 0%, #060a10 50%, #04060c 100%)",
        color: "#fff",
        ...
        <nav style={{
          ...
          background: "rgba(4,6,12,0.6)", backdropFilter: "blur(12px)",
          position: "sticky", top: 0, zIndex: 50,
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{
              width: "32px", height: "32px", borderRadius: "8px",
              background: "linear-gradient(135deg, #63d2ff 0%, #3b82f6 100%)",
              display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px",
            }}>⚡</div>
            <span style={{ fontWeight: 700, fontSize: "16px" }}>CareerForge</span>
            <span style={{
              fontSize: "10px", padding: "2px 8px", borderRadius: "20px",
              background: "rgba(99,210,255,0.1)", color: "#63d2ff",
        ...
        {step === "input" && (
          <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 24px" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <div style={{
                display: "inline-block", fontSize: "11px", padding: "4px 14px", borderRadius: "20px",
                background: "rgba(99,210,255,0.08)", color: "#63d2ff", marginBottom: "16px",
                fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em",
                border: "1px solid rgba(99,210,255,0.2)",
              }}>POWERED BY ADZUNA + GEMINI</div>
              <h1 style={{ fontSize: "clamp(28px, 5vw, 52px)", fontWeight: 800, lineHeight: 1.1, marginBottom: "16px" }}>
                Know Exactly Where<br />
                <span style={{
                  background: "linear-gradient(90deg, #63d2ff 0%, #3b82f6 50%, #a78bfa 100%)",
                  WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
                }}>You Stand in the Market</span>
              </h1>
            ...
            {error && (
              <div style={{
                ...
                color: "#fda4af", fontSize: "13px", fontFamily: "'JetBrains Mono', monospace",
              }}>{error}</div>
            )}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: "11px", color: "#63d2ff", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "16px" }}>
                  TARGET ROLE
                </div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", marginBottom: "16px" }}>
                  {POPULAR_ROLES.map((r) => (
                    <button key={r} className="hover-chip"
                      onClick={() => setRole(r)}
                      style={{
                        padding: "4px 10px", borderRadius: "20px", fontSize: "11px", cursor: "pointer",
                        background: role === r ? "rgba(99,210,255,0.15)" : "rgba(255,255,255,0.05)",
                        border: `1px solid ${role === r ? "rgba(99,210,255,0.4)" : "rgba(255,255,255,0.08)"}`,
                        color: role === r ? "#63d2ff" : "rgba(255,255,255,0.5)",
                        fontFamily: "'Syne', sans-serif",
                ...
                <input
                  ...
                  style={{
                    ...
                    color: "#fff", outline: "none", fontFamily: "'Syne', sans-serif", marginBottom: "16px",
                  }}
                />

                <div style={{ fontSize: "11px", color: "#63d2ff", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "10px" }}>
                  CITY
                </div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                  {INDIAN_CITIES.map((c) => (
                    <button key={c} className="hover-chip"
                      onClick={() => setCity(c)}
                      style={{
                        padding: "4px 10px", borderRadius: "20px", fontSize: "11px", cursor: "pointer",
                        background: city === c ? "rgba(99,210,255,0.15)" : "rgba(255,255,255,0.05)",
                        border: `1px solid ${city === c ? "rgba(99,210,255,0.4)" : "rgba(255,255,255,0.08)"}`,
                        color: city === c ? "#63d2ff" : "rgba(255,255,255,0.5)",
                        fontFamily: "'Syne', sans-serif",
                        transition: "all 0.15s",
                      }}
                    >{c}</button>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                <div style={{
                  ...
                  <textarea
                    ...
                    rows={7}
                    style={{
                      width: "100%", padding: "12px", borderRadius: "10px", fontSize: "12px",
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.35)", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "10px" }}>
                    JOB DESCRIPTION (optional)
                  </div>
                  <textarea
                    value={jd}
                    onChange={(e) => setJd(e.target.value)}
                    placeholder="Paste a specific job description for targeted analysis..."
                    rows={4}
                    style={{
                      width: "100%", padding: "12px", borderRadius: "10px", fontSize: "12px",
                      background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)",
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "32px" }}>
              <button
                ...
                style={{
                  ...
                  background: "linear-gradient(135deg, #63d2ff 0%, #3b82f6 100%)",
                  border: "none", color: "#060a10", cursor: "pointer",
                  fontFamily: "'Syne', sans-serif",
                  transition: "all 0.2s ease",
                  boxShadow: "0 4px 24px rgba(99,210,255,0.25)",
                }}
              >
          ...
          <div style={{
            ...
            <div style={{ position: "relative", width: "120px", height: "120px" }}>
              <div style={{
                ...
                border: "2px solid rgba(99,210,255,0.15)",
              }} />
              <div style={{
                position: "absolute", inset: "15px", borderRadius: "50%",
                border: "2px solid rgba(99,210,255,0.1)",
              }} />
              <div style={{
                position: "absolute", inset: "30px", borderRadius: "50%",
                border: "2px solid rgba(99,210,255,0.08)",
              }} />
              <div style={{
                position: "absolute", inset: 0, borderRadius: "50%",
                border: "2px solid transparent",
                borderTopColor: "#63d2ff",
          ...
          <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "40px 24px 80px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
                <div>
                  ...
                  <p style={{ color: "rgba(255,255,255,0.4)", fontSize: "13px", fontFamily: "'JetBrains Mono', monospace", marginTop: "4px" }}>
                    {result.city} · {result.totalJobs.toLocaleString()} active listings analysed
                  </p>
                </div>
                <div style={{ display: "flex", gap: "10px" }}>
                  <button
                    ...
                    style={{
                      ...
                      background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)",
                      color: "rgba(255,255,255,0.6)", cursor: "pointer", fontFamily: "'Syne', sans-serif",
                    }}
                  >← Re-analyse</button>
                  <button
                    ...
                    style={{
                      ...
                      background: "linear-gradient(135deg, #63d2ff 0%, #3b82f6 100%)",
                      border: "none", color: "#060a10", cursor: "pointer", fontFamily: "'Syne', sans-serif",
                    }}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
              ...
              <div className="card-in" style={{
                ...
                <div style={{ fontSize: "11px", color: "#63d2ff", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "20px" }}>
                  COMPATIBILITY SCORE
                </div>
              ...
              <div className="card-in" style={{
                ...
                <div style={{ fontSize: "11px", color: "#63d2ff", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "20px" }}>
                  SALARY BENCHMARK · {result.city.toUpperCase()}
                </div>
                <SalarySlider
                  min={result.salaryMin}
                  max={result.salaryMax}
                  userVal={result.userSalaryEstimate}
                  animating={animated}
                />
                <div style={{
                  marginTop: "20px", padding: "12px 14px", borderRadius: "10px",
                  background: "rgba(99,210,255,0.06)", border: "1px solid rgba(99,210,255,0.15)",
                }}>
                  <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)", fontFamily: "'JetBrains Mono', monospace" }}>
                    Based on {result.totalJobs.toLocaleString()} live listings on Adzuna India
                  </p>
                </div>
              </div>
            </div>

            {/* Bottom row: Gaps + Cheat Sheet */}
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              ...
              <div className="card-in" style={{
                ...
                <div style={{ fontSize: "11px", color: "#f43f5e", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em", marginBottom: "20px" }}>
                  ⚠ CRITICAL GAP ALERTS
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  {result.missingSkills.length === 0 && (
                    <p style={{ color: "#22d3a0", fontSize: "14px" }}>🎉 No critical gaps found!</p>
                  )}
                </div>
              </div>
              ...
              <div className="card-in" style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px" }}>
                  <div style={{ fontSize: "11px", color: "#a78bfa", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.1em" }}>
                    🎯 INTERVIEW CHEAT SHEET
                  </div>
                  <button
                    onClick={launchInterview}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                  {result.cheatSheet.map((item, i) => (
                    <div key={i} style={{
                      ...
                      <p style={{ fontSize: "13px", fontWeight: 600, color: "rgba(255,255,255,0.9)", marginBottom: "6px", lineHeight: 1.4 }}>
                        Q{i + 1}. {item.question}
                      </p>
                      <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", fontFamily: "'JetBrains Mono', monospace", lineHeight: 1.5 }}>
                        💡 {item.hint}
                      </p>
                    </div>
                  ))}
